...
module.exports = {
  ...
  get_token_info: function (tokenName, cb) {
    rpcCommand([{ method: 'listtokens', parameters: [tokenName, true] }], function (response) {
      return cb(response);
    });
  },

  get_token_info_promise: function (tokenName) {
    return new Promise((resolve, reject) => {
      module.exports.get_token_info(
        tokenName,
        (response) => {
          resolve(response);
        }
  ...
  get_token_utxos_promise: function (queryObj) {
    return new Promise((resolve, reject) => {
      module.exports.get_token_utxos(
        queryObj,
        (response) => {
          resolve(response);
        }
  ...
  get_token_balance_promise: function (queryObj) {
    return new Promise((resolve, reject) => {
      module.exports.get_token_balance(
        queryObj,
        (response) => {
          resolve(response);
        }
