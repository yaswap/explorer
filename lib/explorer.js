...
const ScriptPubKeyType = {
  ...
  CLTV_P2SH_timelock: 'CLTV_P2SH_timelock',
  CSV_P2SH_timelock: 'CSV_P2SH_timelock',
};
      ...
      async function (loop) {
        ...
        if (vout[i].scriptPubKey.type != 'nonstandard' && vout[i].scriptPubKey.type != 'nulldata') {
          ...
          if (
            ...
            var block = null;
            if (vout[i].scriptPubKey.type == ScriptPubKeyType.CSV_P2PKH_timelock) {
