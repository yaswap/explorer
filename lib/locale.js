...
(exports.menu_explorer = 'Explorer'),
  ...
  (exports.ex_submit_button = 'Submit'),
  (exports.ex_redeemscript_message = 'Input a redeemscript'),
  ...
  (exports.ex_duplicate_redeemscript = 'The redeemscript already exists'),
  (exports.ex_redeemscript_error = 'The redeemscript is invalid'),
  (exports.tl_timelocked_amount = 'Timelocked coins amount'),
  ...
  // Wallet Download view
  (exports.wallet_title = 'Wallet download'),
  (exports.wallet_introduction = 'It also supports the execution of atomic swaps within the wallet itself.'),
